...
fromGregorian :: Int64 -> Int -> Int -> Day
...
fromGregorianValid :: Int64 -> Int -> Int -> Maybe Day
...
gregorianMonthLength :: Int64 -> Int -> Int
gregorianMonthLength year = monthLength (isLeapYear year)

rolloverMonths :: (Int64,Int64) -> (Int64,Int)
rolloverMonths (y,m) = (y + (div (m - 1) 12),fromIntegral (mod (m - 1) 12) + 1)

addGregorianMonths :: Int64 -> Day -> (Int64,Int,Int)
...
addGregorianMonthsClip :: Int64 -> Day -> Day
...
addGregorianMonthsRollOver :: Int64 -> Day -> Day
...
addGregorianYearsClip :: Int64 -> Day -> Day
...
addGregorianYearsRollOver :: Int64 -> Day -> Day
